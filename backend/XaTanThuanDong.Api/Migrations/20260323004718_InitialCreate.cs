        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcessingTime = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Fee = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FormTemplateUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ServiceProcedureId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Articles_CategoryId_Status_PublishedAtUtc",
                table: "Articles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_ArticleId_IsApproved_CreatedAtUtc",
                table: "Comments",
                columns: new[] { "ArticleId", "IsApproved", "CreatedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceApplications_ServiceProcedureId_Status_SubmittedAtUtc",
                table: "ServiceApplications",
                columns: new[] { "ServiceProcedureId", "Status", "SubmittedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_ServiceProcedures_Name",
