  ...
  return (
    <div>
      ...
      <div className="d-flex align-items-end justify-content-between mb-3">
        <div>
          <div className="badge text-bg-primary">Danh mục</div>
          <h1 className="h3 fw-bold mb-0">Quản lý danh mục</h1>
        </div>
      ...
      <div className="row g-3">
        <div className="col-12 col-lg-5">
          <div className="p-4 bg-white border rounded-4">
            <div className="fw-bold mb-2">{isCreate ? 'Tạo danh mục' : 'Cập nhật danh mục'}</div>
