...
export default function AdminProceduresPage() {
  ...
  return (
    <div>
      <Helmet>
        <title>Thủ tục | Admin</title>
      </Helmet>

      <div className="d-flex align-items-end justify-content-between mb-3">
        <div>
          <div className="badge text-bg-primary">Thủ tục</div>
          <h1 className="h3 fw-bold mb-0">Quản lý thủ tục hành chính</h1>
        </div>
      ...
      <div className="row g-3">
        <div className="col-12 col-lg-5">
          <div className="p-4 bg-white border rounded-4">
            <div className="fw-bold mb-2">{isCreate ? 'Tạo thủ tục' : 'Cập nhật thủ tục'}</div>
