  ...
  return (
    <div>
      ...
      <div className="d-flex align-items-end justify-content-between mb-3">
        <div>
          <div className="badge text-bg-primary">Dịch vụ</div>
          <h1 className="h3 fw-bold mb-0">Hồ sơ</h1>
        </div>
      ...
      <div className="row g-3">
            ...
            <div className="table-responsive">
              <table className="table mb-0">
                ...
                <tbody>
                  ...
                  {apps.length === 0 ? (
                    <tr>
                      <td colSpan="4" className="text-muted p-4">Chưa có hồ sơ.</td>
                    </tr>
                  ) : null}
                </tbody>
              </table>
        ...
        <div className="col-12 col-lg-4">
          <div className="p-4 bg-white border rounded-4">
            <div className="fw-bold mb-2">Cập nhật trạng thái</div>
