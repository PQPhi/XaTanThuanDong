  ...
  return (
    <div>
      ...
      <div className="d-flex align-items-end justify-content-between mb-3">
        <div>
          <div className="badge text-bg-primary">Người dùng</div>
          <h1 className="h3 fw-bold mb-0">Quản lý tài khoản</h1>
          <div className="text-muted small">CRUD + phân quyền (Admin/Editor/Viewer)</div>
        </div>
      ...
      <div className="row g-3">
        <div className="col-12 col-lg-5">
          <div className="p-4 bg-white border rounded-4">
            <div className="fw-bold mb-2">{isCreate ? 'Tạo tài khoản' : 'Cập nhật tài khoản'}</div>
                ...
                <div className="d-flex gap-2 flex-wrap">
                  {ALL_ROLES.map((r) => (
                    <button
                      key={r}
                      type="button"
                      className={`btn btn-sm ${form.roles.includes(r) ? 'btn-primary' : 'btn-outline-primary'}`}
            ...
            <div className="table-responsive">
              <table className="table mb-0 align-middle">
                ...
                <tbody>
                  ...
                  {items.length === 0 ? (
                    <tr>
                      <td colSpan="5" className="text-muted p-4">Chưa có dữ liệu.</td>
                    </tr>
                  ) : null}
                </tbody>
              </table>
